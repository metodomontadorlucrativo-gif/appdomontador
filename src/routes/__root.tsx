...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image:alt", content: "Logo TRENA em laranja com o slogan Controle financeiro gamificado para autônomos" },
      ...
      { name: "twitter:image:alt", content: "Logo TRENA em laranja com o slogan Controle financeiro gamificado para autônomos" },
    ],
    links: [
